import pandas as pd
from numeric_features import get_y, feature_computation_preprocessing
...
def test_get_y():
    print(get_y(get_dummy_sales()))


def test_feature_computation():
    print(feature_computation_preprocessing(get_dummy_sales(), process_count=2))
